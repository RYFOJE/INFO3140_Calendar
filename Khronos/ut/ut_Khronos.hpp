...
#define GREGORIAN_CALENDAR_GROUP	"{1} Gregorian Calendar"
#define JULIAN_CALENDAR_GROUP		"{2} Julian Calendar"
#define MIXED_CALENDAR_GROUP		"{3} Mixed Calendar"
#define ISLAMIC_CALENDAR_GROUP		"{4} Islamic Calendar"
#define HEBREW_CALENDAR_GROUP		"{5} Hebrew Calendar"
#define VULCAN_CALENDAR_GROUP		"{6} Vulcan Calendar"
